return {
  ...
  },
  {
    ...
    config = function()
      ...
      -- setup the lua language server using vim.lsp.config
      ...
      -- setup the typescript language server (ts_ls) using vim.lsp.config
      ...
      -- Enable language servers on their respective filetypes
